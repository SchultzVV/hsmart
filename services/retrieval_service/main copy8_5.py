...
# 🔥 Usando pipeline do Hugging Face com `flan-t5-small` (mais otimizado)
...
def generate_answer(question, context):
    """Gera uma resposta melhor estruturada usando FLAN-T5-SMALL"""

    prompt = f"Baseado no seguinte contexto, responda de forma clara e objetiva:\n\nContexto:\n{context}\n\nPergunta: {question}\nResposta:"

    response = generator(
        prompt,
        max_length=200,  # 🔹 Agora permite respostas mais completas
